...
public interface IGoParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNonNamedType([NotNull] GoParser.NonNamedTypeContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="GoParser.nonNamedType"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNonNamedType([NotNull] GoParser.NonNamedTypeContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterEmbeddedField([NotNull] GoParser.EmbeddedFieldContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="GoParser.embeddedField"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitEmbeddedField([NotNull] GoParser.EmbeddedFieldContext context);
	/// <summary>
